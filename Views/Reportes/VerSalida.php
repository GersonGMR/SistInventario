...
include "./conexion.php";
        ...
        $entradas = mysqli_query($conexion, "SELECT SUM(d.cantidad) as cantidad, p.nombre,p.medida FROM detalle_venta d
...
$pdf->Cell(80, 8, utf8_decode("Detalle de los productos salientes"), 0, 1, 'C');
$pdf->setFont('Arial', 'B', 10);

...
$pdf->Cell(85, 2, utf8_decode("Convoy Of Hope de El Salvador"), 0, 0, 'C');
$pdf->Ln(8);
...
$pdf->setFont('Arial', '', 6);
$pdf->Cell(30, 5, utf8_decode("Licda. Aida Guardado"), 0, 0, 'L');
$pdf->setFont('Arial', 'B', 6);
...
$pdf->setFont('Arial', '', 6);
$pdf->Cell(30, 5, utf8_decode("Sr. Julio Arias"), 0, 0, 'L');
$pdf->setFont('Arial', 'B', 6);
$pdf->Cell(30, 5, utf8_decode("Firma: "), 0, 0, 'L');
$pdf->Ln(5);
$pdf->setFont('Arial', 'B', 6);
